...
<div class="recipe-form-container">
  <form id="recipeForm">
    ...
    <div class="form-actions">
      <button type="submit" class="btn-primary">Générer le fichier de recette</button>
      <button type="button" class="btn-secondary" onclick="resetForm()">Réinitialiser</button>
    </div>
  </form>

  <div id="output" style="display: none;">
    <h2>Fichier de recette généré</h2>
    <p>Copiez le contenu ci-dessous et créez un nouveau fichier dans le dossier <code>recettes/</code> avec l'extension <code>.qmd</code></p>
    <div class="filename-suggestion">
      <strong>Nom suggéré:</strong> <code id="suggestedFilename"></code>
    </div>
    <textarea id="generatedContent" readonly rows="20"></textarea>
    <button class="btn-primary" onclick="copyToClipboard()">📋 Copier dans le presse-papiers</button>
  </div>
</div>
